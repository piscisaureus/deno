...
def get_gn_args():
    ...
    if cc_wrapper:
        ...
        # For cc_wrapper to work, we need to override 'custom_toolchain' and
        # 'host_toolchain' in args.gn.
        # TODO: is there a way to do this automatically and not use args.gn?
        if os.name == "nt":
